...
export default (code: number, title?: string, message?: string, stack?: string) => `<!DOCTYPE html><html><head><title>Error&nbsp;${
  code
  }&nbsp;-&nbsp;${
  title
  }</title><link rel='stylesheet' type='text/css' href='https://fonts.googleapis.com/css?family=Open+Sans'/><style>html,body{-webkit-touch-callout:none;${
  stack ? "" : "-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;"
